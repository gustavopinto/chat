...
public class ModeradorTest {
	...
	public void novoGrupoComUmParticipanteTest() {
		Moderador gustavo = new Moderador("Gustavo");
		Grupo turmaOO2 = gustavo.criarGrupo("Turma OO2");
		Assertions.assertEquals(1, turmaOO2.getParticipantes().length);
		
		Assertions.assertEquals("Gustavo", turmaOO2.getParticipantes()[0].getNome());
	}
	...
	public void adicionarParticipanteTest() {
		...
		Assertions.assertEquals(2, turmaOO2.getParticipantes().length);
	}
	...
	public void adicionarVariosParticipantesTest() {
		...
		Assertions.assertEquals(4, turmaOO2.getParticipantes().length);
	}
	...
	public void grupoSemMensagemTest() {
		...
		Assertions.assertEquals(0, turmaOO2.getMensagens().length);
	}
	...
	public void enviarMensagemTest() {
		...
		Assertions.assertEquals(1, turmaOO2.getMensagens().length);
	}
	...
	public void enviarVariasMensagensTest() {
		...
		Assertions.assertEquals(4, turmaOO2.getMensagens().length);
	}
